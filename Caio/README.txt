...
7. Quando abrir a página "Upload" escolha um arquivo CSV ou XLSX(excel), esses arquivos devem estar na pasta Caio.

obs1: É necessário uma planilha (XLSX) ou CSV com apenas 5 colunas. Siga o exemplo dos arquivos "teste" e "teste2".
...
"inventario" do banco de dados (uma mensagem de sucesso é mostrada nessa tela).

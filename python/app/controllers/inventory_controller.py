...
def list_inventory():
    if(request.args != {}):
        ...
        if not manufacturer == '': querys.append(Product.product_manufacturer == manufacturer)
        if not model == '': querys.append(Product.product_model == model)
        if not color == '': querys.append(Product.product_color == color)
        if not carrier_plan_type == '': querys.append(Product.product_carrier_plan_type == carrier_plan_type)

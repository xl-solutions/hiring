...
1. Acesse o diretório atual pelo prompt de comando.
2. Com uma instalação do node.js, execute o comando `npm install`. Isso irá instalar todas as dependências
